...
void TP_DrawPoint(uint16_t Xpos,uint16_t Ypos,uint16_t color)
{
  ...
  LCD_SetPoint(Xpos+1,Ypos,color);
  LCD_SetPoint(Xpos,Ypos+1,color);
  LCD_SetPoint(Xpos+1,Ypos+1,color);
}	
...
void DrawCross(uint16_t Xpos,uint16_t Ypos)
{
  ...
  LCD_DrawLine(Xpos-15,Ypos+15,Xpos-7,Ypos+15,0xf800);
  LCD_DrawLine(Xpos-15,Ypos+7,Xpos-15,Ypos+15,0xf800);

  LCD_DrawLine(Xpos-15,Ypos-15,Xpos-7,Ypos-15,0xf800);
  LCD_DrawLine(Xpos-15,Ypos-7,Xpos-15,Ypos-15,0xf800);

  LCD_DrawLine(Xpos+7,Ypos+15,Xpos+15,Ypos+15,0xf800);
  LCD_DrawLine(Xpos+15,Ypos+7,Xpos+15,Ypos+15,0xf800);

  LCD_DrawLine(Xpos+7,Ypos-15,Xpos+15,Ypos-15,0xf800);
  LCD_DrawLine(Xpos+15,Ypos-15,Xpos+15,Ypos-7,0xf800);
}	
/*******************************************************************************
